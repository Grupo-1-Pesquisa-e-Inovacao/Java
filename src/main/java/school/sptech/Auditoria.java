...
public class Auditoria {
    ...
    public void auditoriaUpdate(String tipo_acao, LocalDateTime data_acao, String status_acao, String classe_acao, int linha_excel) {
    ...
    public void auditoriaInsertProcessamento(String nome_arquivo, LocalDateTime data_acao, Integer linhas_processadas, String status) {
    ...
    public void auditoriaUpdateProcessamento(String nome_arquivo, LocalDateTime data_acao, Integer linhas_processadas, String status) {
